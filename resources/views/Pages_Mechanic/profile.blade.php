        ...
        <div class="col-md-3 hidden-sm">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <!-- Image card -->
                    <div class="card">
                      <img class="card-img-top" style="max-width: 230px;" src="{{ asset('avatar/Male-Avatar.png') }}" alt="Card image cap">
                      <div class="card-block">
                       ...
                       {{--  <strong> My Price</strong>
                         @foreach ($mechanic_profile->mechanicSkills as $amount)
                          <p class="list-group-item-text">{{ $amount->amount }}</p>
                        @endforeach --}}
                        </p>
                      </div>
                      <ul class="list-group list-group-flush">
                        <p>Minimum Charge for:</p>
                        <li class="list-group-item"><label>Change oil: 250 </label></li>
                        <li class="list-group-item"><label>Tune-up: 1000 </label></li>
                        ...
                        <div style="display: none;" id="show-contact" ><br><h5>Contact:</h5>  
                        @foreach ($mechanic_profile->mechanicNumbers as $contact)
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div id="review-form" style="display: none;">
                      <form method="POST" action="/mechanic/profile/{{ $mechanic_profile->id }}/comment" >
                        {{ csrf_field() }}

                        <!-- Star rating -->
                          <fieldset class="rating">
                              <input type="radio" id="star5" name="rating" value="5" />
                              <label data-toggle="tooltip" data-placement="top" class = "full" for="star5" title="Sobrang galing si Koya - 5 stars"></label>
                              ...
                              <label data-toggle="tooltip" data-placement="top" class = "full" for="star4" title="Magaling si Koya - 4 stars"></label>

                              <!-- <input type="radio" id="star3half" name="rating" value="3.5" />
                              <label data-toggle="tooltip" data-placement="top" class="half" for="star3half" title="Meh - 3.5 stars"></label> -->

                              <input type="radio" id="star3" name="rating" value="3" />
                              <label data-toggle="tooltip" data-placement="top" class = "full" for="star3" title=" Average si Koya - 3 stars"></label>

                              <!-- <input type="radio" id="star2half" name="rating" value="2.5" />
                              <label data-toggle="tooltip" data-placement="top" class="half" for="star2half" title="Kinda bad - 2.5 stars"></label> -->

                              <input type="radio" id="star2" name="rating" value="2" />
                              <label data-toggle="tooltip" data-placement="top" class = "full" for="star2" title="Medyo mahina si Koya - 2 stars"></label>

                              <!-- <input type="radio" id="star1half" name="rating" value="1.5" />
                              <label data-toggle="tooltip" data-placement="top" class="half" for="star1half" title="Meh - 1.5 stars"></label> -->

                              <input type="radio" id="star1" name="rating" value="1" />
                              <label data-toggle="tooltip" data-placement="top" class = "full" for="star1" title="Hayyyy si Koya - 1 star"></label>
                        ...
                        <section class="comment-list">
                          ...
                          <article class="row" style="font-size: 12px;">
                            <div class="col-md-1 col-sm-1 hidden-xs">
                              <figure class="">
                                <img class="img-responsive img-rounded" src="{{ asset('avatar/Male-Avatar.png') }}" />
                              </figure>
                            </div>
                            <div class="col-md-11 col-sm-11">
                                  ...
                                  <header class="text-left">
                                    ...
                                    <time class="comment-date" datetime="16-12-2014 01:05"><i class="fa fa-clock-o">{{ $user->pivot->created_at->diffForHumans() }}</i> | <span class="stars" data-rating="{{ $user->pivot->rating }}" data-num-stars="{{ $user->pivot->rating }}" ></span></time>
                                  </header>
                                  <div class="comment-post">
                                    ...
                                    <p>
                                      @guest
                                        no delete
                                      @else
                                        <span class="glyphicon glyphicon-trash"> | <a href="/mechanic/testimonial/{{ $user->pivot->id }}/edit"><span class="glyphicon glyphicon-edit"></a>
                                      @endguest
                                    </p>
                                  </div>
